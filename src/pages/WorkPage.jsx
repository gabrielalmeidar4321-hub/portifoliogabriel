...
const projects = [
  {
    ...
    {
    title: 'Landing Page TaskByte – Sistema de Gestão de Estoque',
    description:
      'A TaskByte é uma software house fictícia criada como parte do TCC do curso Técnico em Análise e Desenvolvimento de Sistemas. O objetivo principal era desenvolver um sistema de gestão de estoque inovador, capaz de substituir planilhas tradicionais como o Excel e oferecer maior eficiência, escalabilidade e segurança na administração de dados.\n\nComo complemento, foi criada uma landing page institucional para apresentar a empresa, suas soluções e cases de sucesso, funcionando como a porta de entrada para potenciais clientes e parceiros. A página foi construída com React, estilizada com Tailwind CSS e estruturada em Node.js, garantindo performance, responsividade e design moderno.',
    images: [asset('taskbyte01.png'), asset('taskbyte02.png'), asset('taskbyte03.png'), asset('taskbyte04.png')],
    techs: ['React.js', 'Tailwind CSS', 'Node.js', 'Eletrônica', 'Automação'],
    link: 'https://example.com'
  },
  {
    ...
    images: [asset('sensor de presença.png'), asset('sensor de presença.png')],
