    ...
    <header className="sticky top-0 z-50 bg-gray-50/80 dark:bg-dark-900/80 backdrop-blur border-b border-gray-200/60 dark:border-dark-50/20">
      <div className="container-base flex items-center justify-between h-16">
        <a href="/#home" className="flex items-center gap-2" aria-label="Logo">
          <img
            src={isDark ? asset('logoescuro.png') : asset('logoclaro.png')}
            alt=""
        ...
        <div className="flex items-center gap-3">
          <a href={asset('Curriculo GabrielR.pdf')} download className="px-3 py-1.5 rounded-full bg-gray-900 text-gray-50 dark:bg-dark-50/20 dark:text-dark-100 border border-gray-900 dark:border-dark-50/40 text-sm">Download CV</a>
